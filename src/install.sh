...
curl --location --output ~/geoserver-2.15.1.zip \
  http://sourceforge.net/projects/geoserver/files/GeoServer/2.15.1/geoserver-2.15.1-bin.zip
...
curl --location --output ~/geoserver-2.15.1-mysql-plugin.zip \
  http://sourceforge.net/projects/geoserver/files/GeoServer/2.15.1/extensions/geoserver-2.15.1-mysql-plugin.zip
...
curl --location --output ~/geoserver-2.15.1-sqlserver-plugin.zip \
  http://sourceforge.net/projects/geoserver/files/GeoServer/2.15.1/extensions/geoserver-2.15.1-sqlserver-plugin.zip
...
curl --location --output ~/geoserver-2.15.1-oracle-plugin.zip \
  http://sourceforge.net/projects/geoserver/files/GeoServer/2.15.1/extensions/geoserver-2.15.1-oracle-plugin.zip
...
curl --location --output ~/geoserver-2.15.1-css-plugin.zip \
  http://sourceforge.net/projects/geoserver/files/GeoServer/2.15.1/extensions/geoserver-2.15.1-css-plugin.zip
...
curl --location --output ~/geoserver-2.15.1-ysld-plugin.zip \
  http://sourceforge.net/projects/geoserver/files/GeoServer/2.15.1/extensions/geoserver-2.15.1-ysld-plugin.zip
...
curl --location --output ~/geoserver-2.15.1-pyramid-plugin.zip \
  http://sourceforge.net/projects/geoserver/files/GeoServer/2.15.1/extensions/geoserver-2.15.1-pyramid-plugin.zip
