...
# geoserver
curl --location --output ~/geoserver.zip http://downloads.sourceforge.net/project/geoserver/GeoServer/2.14.1/geoserver-2.14.1-bin.zip
unzip ~/geoserver.zip -d / && mv -v /geoserver* /geoserver
rm ~/geoserver.zip

# geoserver-mysql-plugin
curl --location --output ~/geoserver-mysql-plugin.zip http://downloads.sourceforge.net/project/geoserver/GeoServer/2.14.1/extensions/geoserver-2.14.1-mysql-plugin.zip
unzip -o ~/geoserver-mysql-plugin.zip -d /geoserver/webapps/geoserver/WEB-INF/lib/
rm ~/geoserver-mysql-plugin.zip

# sqlserver-plugin
curl --location --output ~/geoserver-sqlserver-plugin.zip http://downloads.sourceforge.net/project/geoserver/GeoServer/2.14.1/extensions/geoserver-2.14.1-sqlserver-plugin.zip
unzip -o ~/geoserver-sqlserver-plugin.zip -d /geoserver/webapps/geoserver/WEB-INF/lib/
rm ~/geoserver-sqlserver-plugin.zip

# oracle-plugin
curl --location --output ~/geoserver-oracle-plugin.zip http://downloads.sourceforge.net/project/geoserver/GeoServer/2.14.1/extensions/geoserver-2.14.1-oracle-plugin.zip
unzip -o ~/geoserver-oracle-plugin.zip -d /geoserver/webapps/geoserver/WEB-INF/lib/
rm ~/geoserver-oracle-plugin.zip

# css-plugin
curl --location --output ~/geoserver-css-plugin.zip http://downloads.sourceforge.net/project/geoserver/GeoServer/2.14.1/extensions/geoserver-2.14.1-css-plugin.zip
unzip -o ~/geoserver-css-plugin.zip -d /geoserver/webapps/geoserver/WEB-INF/lib/
rm ~/geoserver-css-plugin.zip

# ysld-plugin
curl --location --output ~/geoserver-ysld-plugin.zip http://downloads.sourceforge.net/project/geoserver/GeoServer/2.14.1/extensions/geoserver-2.14.1-ysld-plugin.zip
unzip -o ~/geoserver-ysld-plugin.zip -d /geoserver/webapps/geoserver/WEB-INF/lib/
rm ~/geoserver-ysld-plugin.zip

# pyramid-plugin
curl --location --output ~/geoserver-pyramid-plugin.zip http://downloads.sourceforge.net/project/geoserver/GeoServer/2.14.1/extensions/geoserver-2.14.1-pyramid-plugin.zip
unzip -o ~/geoserver-pyramid-plugin.zip -d /geoserver/webapps/geoserver/WEB-INF/lib/
rm ~/geoserver-pyramid-plugin.zip

# vectortiles-plugin
curl --location --output ~/geoserver-vectortiles-plugin.zip http://downloads.sourceforge.net/project/geoserver/GeoServer/2.14.1/extensions/geoserver-2.14.1-vectortiles-plugin.zip
